...
#check_all: all run_all crossbar_check processor_check testWriteReadTransfers_check singleCoreBus_check singleCoreCrossbar2_check singleCoreCrossbar4_check testMemory_check testCompositeChannel_check DualCore_check QuadCore_check QuadCoreMemoryBound_check QuadCoreMemoryBound_check ModuloScheduling_check MemoryRelocation_check ArchitectureWithNoC_check ArchitectureWithNoCMulticast_check ModuloSchedulingRecurrences_check

check_all: all run_all crossbar_check processor_check testWriteReadTransfers_check singleCoreBus_check singleCoreCrossbar2_check singleCoreCrossbar4_check testMemory_check testCompositeChannel_check DualCore_check QuadCore_check QuadCoreMemoryBound_check QuadCoreMemoryBound_check ArchitectureWithNoC_check ArchitectureWithNoCMulticast_check

all: crossbar  processor testWriteReadTransfers singleCoreBus singleCoreCrossbar2 singleCoreCrossbar4 testMemory testCompositeChannel DualCore QuadCore QuadCoreMemoryBound ArchitectureWithNoC ArchitectureWithNoCMulticast 
#all: crossbar  processor testWriteReadTransfers singleCoreBus singleCoreCrossbar2 singleCoreCrossbar4 testMemory testCompositeChannel DualCore QuadCore QuadCoreMemoryBound ModuloScheduling MemoryRelocation ArchitectureWithNoC ArchitectureWithNoCMulticast ModuloSchedulingRecurrences

run_all: crossbar_run processor_run testWriteReadTransfers_run singleCoreBus_run singleCoreCrossbar2_run singleCoreCrossbar4_run testMemory_run testCompositeChannel_run DualCore_run QuadCore_run QuadCoreMemoryBound_run ArchitectureWithNoC_run ArchitectureWithNoCMulticast_run
#run_all: crossbar_run processor_run testWriteReadTransfers_run singleCoreBus_run singleCoreCrossbar2_run singleCoreCrossbar4_run testMemory_run testCompositeChannel_run DualCore_run QuadCore_run QuadCoreMemoryBound_run ModuloScheduling_run MemoryRelocation_run ArchitectureWithNoC_run ArchitectureWithNoCMulticast_run ModuloSchedulingRecurrences_run
...
ModuloSchedulingRecurrences_run:
	...
	./python/merge-csv-files.py processor-utilization-Tile1_Processor0.csv processor-utilization-Tile1_Processor1.csv crossbar-utilization-crossbar_Tile1.csv NoC-utilization-NoC.csv -o testcase-architecture-Modulo-Scheduling-Recurrences.csv;
