...
public class testSingleCore {
    public static void main(String[] args) throws IOException {
      ...
      Fifo c1 = new Fifo(1,"c1",0,1,1000000,memory1,1,1);
      Fifo c2 = new Fifo(2,"c2",0,1,1000000,memory1,1,1);
      Fifo c3 = new Fifo(3,"c3",0,1,1000000,memory1,1,1);
      Fifo c4 = new Fifo(4,"c4",0,1,1000000,memory1,1,1);
      Fifo c5 = new Fifo(5,"c5",0,1,1000000,memory1,1,1);
